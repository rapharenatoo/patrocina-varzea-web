      ...
      <main className={styles.container}>
        <div className={styles.content}>
          <div className={styles.text}>
            ...
            <p>
              A sua privacidade é importante para nós. É política do Patrocina
              Várzea respeitar a sua privacidade em relação a qualquer
              informação sua que possamos coletar no site{" "}
              <a href="https://patrocinavarzea.vercel.app/">
                Patrocina Várzea{" "}
              </a>
            ...
            <p>
              Para efetivar o cancelamento desta política de privacidade, enviar
              um e-mail para{" "}
              <a href="">
                contato@patrocinavarzea.com.br
              </a>
            </p>
            <p>Esta política é efetiva a partir de Agosto / 2022.</p>
          </div>
        </div>
      </main>
      <Footer />
